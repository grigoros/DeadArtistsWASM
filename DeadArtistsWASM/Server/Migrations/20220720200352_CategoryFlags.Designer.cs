...
namespace DeadArtistsWASM.Server.Migrations
{
    ...
    [Migration("20220720200352_CategoryFlags")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeadArtistsWASM.Shared.CartItem", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DeadArtistsWASM.Shared.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DeadArtistsWASM.Shared.OrderItem", b =>
                {
            ...
            modelBuilder.Entity("DeadArtistsWASM.Shared.Address", b =>
                {
                    b.HasOne("DeadArtistsWASM.Shared.User", null)
                        .WithOne("Address")
                        .HasForeignKey("DeadArtistsWASM.Shared.Address", "UserId")
            ...
            modelBuilder.Entity("DeadArtistsWASM.Shared.OrderItem", b =>
                {
                    b.HasOne("DeadArtistsWASM.Shared.Order", "Order")
                        .WithMany("OrderItems")
